...
7. Calculate final activity scores
...
4. **Use the activity scores** generated by `calculate_activity_scores()` for downstream analysis
5. **For production runs**, adapt the code into Savio job scripts for reproducibility

The activity scores integrate AD and RT data to calculate gene-level activity metrics across timepoints and replicates. See the documentation in `../../docs/user_guide/trebl_experiment.md` for more details on interpreting these scores.
